...
# ADMIN FUNCTIONS
def update_table(db: database.SessionLocal, table_name: str, query_filter: dict, updated_fields: dict, rollback: bool = False) -> list[Row]:
...
if __name__ == '__main__':
    ...
    res = query_table(db, "Products", {"ProductId": "N82E16814126708"})
