...
class NewEggScraper:
    ...
    def __post_init__(self) -> None:
        self.scraper_logger = CustomLogger(logger_name="Scraper", log_file_name=f"{Config.LOGS_FOLDER}/scraperLogs.txt",
    ...
    def start_scraping(self, phrase: str, max_pages: int = 0, execution_id: int = 0, save: bool = True) -> Tuple[List[dict], List[dict]]:
        ...
        if save:
            ...
            folder = rf"{Config.SINK_FOLDER}/data_{execution_id}_{time_now}"
            os.mkdir(folder)
...
if __name__ == '__main__':
    ...
    sc.start_scraping(phrase="rtx+3050", max_pages=0)